    ...
    <div className="">
      ...
      {side && (
        <div
          ...
          className="fixed left-0 top-0 z-50 w-screen h-screen pt-[70px] sm:pt-[75px]"
        >
          <div className="fixed shadow-xs z-30 h-full lg:w-[10%] md:w-[12%] sm:w-[13%] w-[20%] left-0  pb-24 overflow-x-hidden overflow-y-scroll bg-white">
            <Link
              to="/"
              className="duration-200 text-primary hover:text-secandari"
            >
